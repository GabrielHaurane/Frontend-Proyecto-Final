...
export const buscarHabitacionesDisponibles = async (fechaEntrada, fechaSalida) => {
  try {
    const respuesta = await fetch(`${URLHabitacion}/catalogo?fechaEntrada=${fechaEntrada}&fechaSalida=${fechaSalida}`);
    if (!respuesta.ok) {
