      ...
      <section className="d-flex flex-wrap flex-column flex-lg-row text-white backCC p-3">
        ...
        <article className="pe-3 col-12 d-flex flex-column align-self-center text-justify">
          ...
          <p className="fs-5">
            ...
            tecnología y las startups. El Hotel Code no solo ofrecía una
            estancia de lujo, sino que también se convirtió en un centro de
            innovación, albergando conferencias tecnológicas, lanzamientos de
